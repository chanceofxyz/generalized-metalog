...
// CAUTION this was a hasty port for a hackathon. Needs testing and refactoring
    ...
    selfy.U01.copula.forEach((copula) => {
        if (copula.function === "GaussianCopula") {
            ...
            for (let i = 0; i < copulaArgs.length; i++) {
                ...
                /* TODO IMPORTANT update HDRv2 using { "counter": "PM_Index","entity": 1,"varId": 6187319,"seed3": 0,"seed4": 0} */
